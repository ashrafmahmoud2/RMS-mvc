...
{
    // ? Production (Docker) DB
    var dbHost = Environment.GetEnvironmentVariable("DB_HOST") ?? "rmsdb";
    var dbName = Environment.GetEnvironmentVariable("DB_NAME") ?? "RMS";
    var dbPassword = Environment.GetEnvironmentVariable("DB_SA_PASSWORD") ?? "Your_password123!";
