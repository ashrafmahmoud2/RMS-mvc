...
namespace RMS.Web.Migrations
{
    ...
    [Migration("20251022202357_AddTOIsClosedAllDayAndIsOpen24HoursBranchWorkingHourExceptionTable")]
    partial class AddTOIsClosedAllDayAndIsOpen24HoursBranchWorkingHourExceptionTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RMS.Web.Core.Models.BranchImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RMS.Web.Core.Models.Customer", b =>
                {
                    b.HasOne("RMS.Web.Core.Models.ApplicationUser", "User")
                        .WithOne("Customer")
                        .HasForeignKey("RMS.Web.Core.Models.Customer", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
